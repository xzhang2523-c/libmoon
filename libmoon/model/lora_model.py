# Methods in this file can refer to:
...
from libmoon.util.prefs import get_random_prefs, get_prefs
...
def evaluate_synthetic(problem, model):
    ...
    uniform_prefs = get_prefs(n_prob=10, n_obj=args.n_obj)
...
if __name__ == '__main__':
    ...
    print('Evaluating...')
    uniform_prefs = get_prefs(n_prob=args.eval_num, n_obj=psl_model.n_obj)
