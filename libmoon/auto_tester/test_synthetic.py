...
from libmoon.util import get_prefs, get_x_init
...
if __name__ == '__main__':
    ...
    parser.add_argument('--agg-name', type=str, default='ls')   # agg_name should only use lowercase letters
    ...
    n_probs = 10
    prefs = get_prefs(n_probs, problem.n_obj, clip_eps=0.02)
