...
from libmoon.solver.gradient import MGDAUBCore, PMGDACore, MOOSVGDCore, GradHVCore, PMTLCore, RandomCore, AggCore
...
if __name__ == '__main__':
    ...
    if args.solver_name == 'epo':
        ...
        core_solver = MGDAUBCore(n_var=None, prefs=None)
