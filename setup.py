...
setup(
    ...
    install_requires=[
        'numpy==1.26.2',
        'torch==2.2.1',
        # Used by multimnist loader to download MNIST when pickle is missing
        'torchvision',
        'matplotlib==3.8.3',
        'tqdm==4.66.2',
        'pymoo==0.6.1.1',
        ...
        'scikit-learn',
        'seaborn>=0.11',
        # OpenCV (headless for CI/server environments)
        'opencv-python-headless>=4.7',
        # Botorch and gpytorch (for Bayesian optimization utilities)
        'gpytorch',
        'botorch'
    ],
